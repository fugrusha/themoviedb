...
public class MovieCastService {
    ...
    public PageResult<MovieCastReadDTO> getAllMovieCasts(UUID movieId, Pageable pageable) {
        Page<MovieCast> movieCasts = movieCastRepository.findByMovieId(movieId, pageable);

        return translationService.toPageResult(movieCasts, MovieCastReadDTO.class);
    }
